...
<p>This calculator is in beta, so please use it with caution. It uses theoretical SEFD values. For information about the array and its capabilities please see the <a href="https://nenufar.obs-nancay.fr/en/astronomer/">NenuFAR webpage at Paris Observatory</a>.</p>
...
<?php
 ...
 echo "<li>No bandwidth losses due to RFI were assumed. This may be unrealistic. Typical band edges are excluded (amounting to keeping 90% channels). This is implicit in the subband bandwidths used here.</ul>";
 $sefdcore = array(
  "15" => "25273",
  "30" => "1234",
  "45" => "835",
