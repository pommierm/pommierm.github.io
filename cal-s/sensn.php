...
<html>
<head>
<title>Compact Array Image noise calculator (beta)</title>
<link href="sensn.css" rel="stylesheet" type="text/css">
</head>

<!--
Compact Array Image sensitivity calculator written by M. Pommier (April 2019) 
...
<h2>Compact Array Image noise calculator</h2>

<p>This calculator is in beta, so please use it with caution. It uses theoretical SEFD values. For information about the compact array simmilar to the LOFAR core stations and its capabilities please see the <a href="https://en.wikipedia.org/wiki/Low-Frequency_Array_(LOFAR)">LOFAR webpage</a>.</p>
...
<?php
 ...
 echo "Extra information for sensitivity computation using baselines:<ul>";
 ...
 echo "<li>No bandwidth losses due to RFI were assumed. This may be unrealistic. Typical band edges are excluded (amounting to keeping 90% channels). This is implicit in the subband bandwidths used here.";
 echo "<li>The user should note that due to calibration errors, ionospheric conditions, elevation and errors in the beam modeling, the measured sensitivity might differ from the theoretical one reported below. Please take into account multiplicative factor of up to 5 times the theoretical noise when estimating the image sensitivity in your proposal.</ul>";
 $sefdcore = array(
  "15" => "25273",
  "30" => "1234",
  "45" => "835",
 ...
 $beam = 206265*((1.22*300/$freq)/(1000*$maxbl));
 $beamstr = sprintf("%.2f",$beam);
 $beamarcm = sprintf("%.2f",($beam/60));
...
if ($confjy > $imsens) {
 ...
 echo " (image will".$isnot." be confusion limited at ".$beamarcm." arcmin resolution)</b></font></p>"; 
...
<p id=credit><i>Written by Mamta Pommier (April 2019) (adapted from LOFAR sensitivity calculator by George Heald, v0.2 (5 July 2012)).
 For additional information about the Compact Array sensitivity calculator described on this page please e-mail: mamtapan@gmail.com </i></p>
<div id=lofar><img src="lbaant.png" width=110px></p>
